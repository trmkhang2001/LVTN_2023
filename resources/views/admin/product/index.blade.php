                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            <div class="w-100 mw-150px">
                                ...
                                <select class="form-select form-select-solid select2-hidden-accessible"
                                    ...
                                    data-kt-ecommerce-product-filter="status" data-select2-id="select2-data-9-xdor"
                                    ...
                                    dir="ltr" data-select2-id="select2-data-10-28iv" style="width: 100%;"><span
                                        class="selection"><span
                                            ...
                                            aria-controls="select2-mh04-container"><span class="select2-selection__rendered"
                                                id="select2-mh04-container" role="textbox" aria-readonly="true"
                                                title="Status"><span
                                    ...
                                    <thead>
                                        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="text-end min-w-100px sorting" tabindex="0"
                                                ...
                                                style="width: 131.35px;">Price</th>
                                            <th class="text-end min-w-100px sorting" tabindex="0"
                                                aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1"
                                                aria-label="Rating: activate to sort column ascending"
                                                style="width: 131.35px;">Rating</th>
                                            <th class="text-end min-w-100px sorting" tabindex="0"
                                                aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1"
                                                aria-label="Status: activate to sort column ascending"
                                                style="width: 131.35px;">Status</th>
                                            <th class="text-end min-w-70px sorting_disabled" rowspan="1"
                                                colspan="1" aria-label="Actions" style="width: 125.438px;">Actions
                                            </th>
                                        </tr>
                                    </thead>
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <form
                                                                action="{{ route('admin.page.product.delete', $product->id) }}"
